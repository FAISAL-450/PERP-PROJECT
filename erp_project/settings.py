...
# 🌍 Hosts and CSRF-(Local & Azure-Azure)
try:
...
DEPARTMENT_EMAIL_MAP = {
    ...
    'tomal@dzignscapeprofessionals.onmicrosoft.com': 'construction',
    'admin@dzignscapeprofessionals.onmicrosoft.com': 'construction,design,salesmarketing,finance',
}
